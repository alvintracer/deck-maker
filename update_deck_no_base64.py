...
# 3. Add Contact Details to thank-you slide
old_contact = """<div class="contact"><b>E-mail</b><span>contact@bonanza-factory.co.kr</span><b>Tel</b><span>02-2632-7774</span><b>Web</b><span>www.bonanza-factory.co.kr</span><b>Address</b><span>서울특별시 영등포구 양평로 12, 정오빌딩 6, 7층</span></div>"""
new_contact = """<div class="contact-info" style="margin-top: 40px; display: flex; justify-content: space-between; font-size: 0.9rem; color: #555; text-align: left; border-top: 1px solid #e0e0e0; padding-top: 20px; line-height: 1.6; max-width: 1000px; margin-left: auto; margin-right: auto;">
    <div style="flex: 1;">
...
if old_contact in content:
    ...
    print("Contact info replaced on thank-you slide.")
else:
    print("Failed to find old_contact.")
